...
export class MicSession {
    constructor({
        ...
        // Firefox ESR: AudioWorklet/ScriptProcessor захват
    ...
    async startLocalCapture() {
        ...
        if ('MediaStreamTrackProcessor' in window) {
            ...
            this._setupAudioWorkletCapture();
        }
    ...
    _setupAudioWorkletCapture() {
        ...
        try {
            ...
            console.log(`🎙️ Mic using AudioWorklet fallback`);
        } catch (e) {
            console.warn('🎙️ AudioWorklet failed, using ScriptProcessorNode:', e);
    ...
    _setupScriptProcessorCapture(audioContext) {
        ...
        this._scriptNode.onaudioprocess = (e) => {
            ...
            try {
                ...
                const numFrames = inputData[0].length;
                const bytesPerSample = 4; // Float32

                // Для f32-planar: каждый канал — отдельный массив в ArrayBuffer
        ...
        console.log(`🎙️ Mic using ScriptProcessorNode fallback`);
    }
    ...
    async _stopLocalCapture() {
        ...
        // Firefox ESR: останавливаем AudioWorklet/ScriptProcessor
